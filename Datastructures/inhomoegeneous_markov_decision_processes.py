...
class InhomogeneousMarkovDecisionProcess:
    
    '''
    Class that represents an inhomogeneous Markov Decision Process, with the states, 
    actions,transitions and rewards
    '''
    
    def __init__(self, dimensions, state_spaces, action_spaces, time_horizon, gamma, transition_kernels,
                 reward_functions):
