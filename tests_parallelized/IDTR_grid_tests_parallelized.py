...
#%%
import IDTR_implementation_parallel
...
importlib.reload(IDTR_implementation_parallel)
...
from IDTR_implementation_parallel import IDTR
...
if __name__ == '__main__':
    ...
    grid_class = IDTR_grid(time_horizon, dimensions, center, side_lengths, max_lengths,
                           max_complexity, goal, gamma, zeta, rho, stepsizes)  
    ...
    algo = IDTR(stepsizes, time_horizon, grid_class.state_spaces, max_complexity, 
                max_lengths, grid_class.actions, 
                obs_actions, obs_rewards, obs_states, gamma, lambdas,
                rho, zeta)
...
#%%
    ...
    '''
    optimal_conditions, optimal_actions = algo.compute_interpretable_policies_main()        
...
#%%
    ...
    for i,dim in enumerate(possible_dims):
        ...
        grid_class = IDTR_grid(time_horizon, dim, center, side_lengths,
    ...
    state_space = DBU(1, 2, np.array([[3,3]]), np.array([[0,0]]), stepsizes = 0.5)
    ...
    #%%
    algo = IDTR(centering_MDP, max_lengths, eta, rho, max_complexity,
